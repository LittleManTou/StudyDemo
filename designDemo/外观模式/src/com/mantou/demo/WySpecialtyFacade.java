...
class Specialty1 extends ImageIcon {
    ...
    Specialty1() {
        super("外观模式/src/com/mantou/img/Specialty11.jpg");
    }
}
...
class Specialty2 extends ImageIcon {
    ...
    Specialty2() {
        super("外观模式/src/com/mantou/img/Specialty12.jpg");
    }
}
...
class Specialty3 extends ImageIcon {
    ...
    Specialty3() {
        super("外观模式/src/com/mantou/img/Specialty13.jpg");
    }
}
...
class Specialty4 extends ImageIcon {
    ...
    Specialty4() {
        super("外观模式/src/com/mantou/img/Specialty14.jpg");
    }
}
...
class Specialty5 extends ImageIcon {
    ...
    Specialty5() {
        super("外观模式/src/com/mantou/img/Specialty21.jpg");
    }
}
...
class Specialty6 extends ImageIcon {
    ...
    Specialty6() {
        super("外观模式/src/com/mantou/img/Specialty22.jpg");
    }
}
...
class Specialty7 extends ImageIcon {
    ...
    Specialty7() {
        super("外观模式/src/com/mantou/img/Specialty23.jpg");
    }
}
...
class Specialty8 extends ImageIcon {
    ...
    Specialty8() {
        super("外观模式/src/com/mantou/img/Specialty24.jpg");
    }
}
